...
const Form: React.FC <FormProps>=(props)=> { 
    ...
    if (!isPromptValid){
        ...
        statusText=`Input must be less than ${props.characterLimit}.`;
    }
    return (
        <>
        <div className="mb-6 text-slate-400">
            <p>
            Tell me what your brand is about and I will Generate branding snippet and keywords for you.
            </p>
        </div>
        ...
        type ="text"
        placeholder="coffee"
        value= {props.prompt} onChange={(e)=>updatePromptValue(e.currentTarget.value)}>
        </input>
